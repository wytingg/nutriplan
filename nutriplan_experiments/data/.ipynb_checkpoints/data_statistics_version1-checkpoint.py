...
class DataStatistics:
    ...
    def __init__(self, data_dir: str = r"work/recipebench/data/10large_scale_datasets"):
...
def main():
    ...
    stats.save_report(report, "work/recipebench/scripts/nutriplan_experiments/results/data_statistics_report.json")
