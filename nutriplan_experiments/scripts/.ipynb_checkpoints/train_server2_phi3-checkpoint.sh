#!/bin/bash
# Server 2: Train Phi-3-mini with 3 seeds
# 预计时间: ~40 hours (3.8B model)
...
echo "========================================"
echo "SERVER 2: Training Phi-3-mini"
echo "========================================"
echo "Model: $MODEL"
echo "Seeds: ${SEEDS[@]}"
...
echo ""
echo "========================================"
echo "SERVER 2 COMPLETED!"
echo "========================================"
echo "Phi-3-mini training finished at $(date)"
