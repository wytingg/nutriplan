#!/bin/bash
# Server 1: Train TinyLlama with 3 seeds
# 预计时间: ~20 hours (1.1B model, fastest)
...
echo "========================================"
echo "SERVER 1: Training TinyLlama"
echo "========================================"
echo "Model: $MODEL"
echo "Seeds: ${SEEDS[@]}"
...
echo ""
echo "========================================"
echo "SERVER 1 COMPLETED!"
echo "========================================"
echo "TinyLlama training finished at $(date)"
